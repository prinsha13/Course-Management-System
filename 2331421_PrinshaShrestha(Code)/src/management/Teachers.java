...
public class Teachers extends JPanel {
	...
	public Teachers(JPanel main, User user) {
		...
		addBtnLbl.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (result == JOptionPane.OK_OPTION) {
					...
					try {
						DatabaseSystem.addTeacher(name, number, email, password);
		...
		editBtnLbl.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (result == JOptionPane.OK_OPTION) {
					...
					String number = numberField.getText().trim();
					try {
						DatabaseSystem.editTeacher(id, name, number, email, password);
		...
		removeBtnLbl.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (result == JOptionPane.OK_OPTION) {
					...
					try {
						DatabaseSystem.deleteTeacher(teacherId);
		...
		JLabel assignBtnLbl = new JLabel(new ImageIcon(Teachers.class.getResource("/assign.png")));
		assignBtnLbl.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				ArrayList<Module> modules = Retrive.getAllModules();
				...
				if (result == JOptionPane.OK_OPTION) {
					if (assignRadioButton.isSelected()) {
						...
						try {
							DatabaseSystem.assignModules(teacherId, moduleId);
						...
						String moduleId = moduleIdField.getText().trim();
						try {
							DatabaseSystem.unassignModules(teacherId, moduleId);
	...
	private void createTable(JPanel students) {
		...
		ArrayList<Teacher> teachersData = Retrive.getTeachers();
	...
	public static Teachers getInstance(JPanel main, User user) {
		if (instance == null) {
